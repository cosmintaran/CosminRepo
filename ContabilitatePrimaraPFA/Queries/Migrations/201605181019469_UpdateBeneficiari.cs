namespace Queries.Migrations
{
    ...
    public partial class UpdateBeneficiari : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        NrFactura = c.String(name: "Nr.Factura", nullable: false, maxLength: 6),
                        DataFactura = c.DateTime(nullable: false, storeType: "date"),
                        Suma = c.Decimal(nullable: false, precision: 18, scale: 0),
                        ContractId = c.Int(),
                        Plata = c.Boolean(nullable: false),
                        PlatitorTVA = c.Boolean(nullable: false),
                    })
